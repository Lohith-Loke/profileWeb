...
export const SITE_DATA = {
  ...
  tagline:
    "software developer| Java | Python | JavaScript | 2+ years Experience",
  ...
  scholar: "rmW-O-cAAAAJ",

  // Your email address (use [at] and [dot] to avoid spam bots)
  email: "addons[at]lohith[dot]io",

  // One-line research tagline used for SEO and social sharing meta tags
  description:
    "NITK Graduate | software engineer | SDE | Java | Python | JavaScript | 2+ years Experience",
